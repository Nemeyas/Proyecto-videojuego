...
public class NaveRoja1 extends Nave{
    ...
    public NaveRoja1(int x, int y, Texture tx, Sound soundChoque, Texture txBala, Sound soundBala) {
    ...
    public void movimiento(SpriteBatch batch, PantallaJuego juego) {
        ...
        if (!herido) {
	        ...
	        if (Gdx.input.isKeyJustPressed(Input.Keys.LEFT)) xVel-=2;
	        if (Gdx.input.isKeyJustPressed(Input.Keys.RIGHT)) xVel+=2;
        	if (Gdx.input.isKeyJustPressed(Input.Keys.DOWN)) yVel-=2;     
	        if (Gdx.input.isKeyJustPressed(Input.Keys.UP)) yVel+=2;
